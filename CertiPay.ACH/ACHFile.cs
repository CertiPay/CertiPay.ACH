...
namespace CertiPay.ACH
{
    ...
    public class Batch
    {
        ...
        public virtual ICollection<EntryDetail> Entries { get; internal set; }
    ...
    public class BatchHeader
    {
        ...
        /// </summary>
        public ServiceClassCode ServiceClass { get; internal set; } = ServiceClassCode.Mixed_Debits_And_Credits;
